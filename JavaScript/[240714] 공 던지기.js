function solution(numbers, k) {
    for (let i = 1; i < k; i++) {
        var ball = numbers.shift();
        numbers.push(ball);
        var pass = numbers.shift();
        numbers.push(pass);
    }
...
// 테스트 17 〉	통과 (0.17ms, 33.6MB)
// 테스트 18 〉	통과 (0.11ms, 33.5MB)
// 테스트 19 〉	통과 (0.11ms, 33.5MB)
// 테스트 20 〉	통과 (0.14ms, 33.5MB)
// 테스트 21 〉	통과 (0.10ms, 33.5MB)
// 테스트 22 〉	통과 (0.22ms, 33.5MB)
// 테스트 23 〉	통과 (0.16ms, 33.6MB)
// 테스트 24 〉	통과 (0.22ms, 33.4MB)
// 테스트 25 〉	통과 (0.10ms, 33.6MB)
// 테스트 26 〉	통과 (0.12ms, 33.5MB)
// 테스트 27 〉	통과 (0.08ms, 33.5MB)
// 테스트 28 〉	통과 (0.17ms, 33.6MB)
// 테스트 29 〉	통과 (0.09ms, 33.6MB)
// 테스트 30 〉	통과 (0.15ms, 33.7MB)
// 테스트 31 〉	통과 (0.17ms, 33.5MB)
// 테스트 32 〉	통과 (0.15ms, 33.5MB)
// 테스트 33 〉	통과 (0.34ms, 33.6MB)
// 테스트 34 〉	통과 (0.21ms, 33.6MB)
// 테스트 35 〉	통과 (0.13ms, 33.6MB)
// 테스트 36 〉	통과 (0.20ms, 33.6MB)
// 테스트 37 〉	통과 (0.16ms, 33.5MB)
// 테스트 38 〉	통과 (0.17ms, 33.7MB)
// 테스트 39 〉	통과 (0.20ms, 33.5MB)
// 테스트 40 〉	통과 (0.12ms, 33.5MB)
// 테스트 41 〉	통과 (0.12ms, 33.5MB)
// 테스트 42 〉	통과 (0.05ms, 33.6MB)
// 테스트 43 〉	통과 (0.27ms, 33.5MB)
// 테스트 44 〉	통과 (0.12ms, 33.5MB)
// 테스트 45 〉	통과 (0.09ms, 33.5MB)
// 테스트 46 〉	통과 (0.17ms, 33.7MB)
// 테스트 47 〉	통과 (0.19ms, 33.5MB)
